...
exports.changeChosenDate = changeChosenDate;
exports.addDataInDate = addDataInDate;
exports.loadDateList = loadDateList;
var CHANGE_CHOSEN_DATE = exports.CHANGE_CHOSEN_DATE = 'CHANGE_CHOSEN_DATE';
var LOAD_DATA_BY_DATE = exports.LOAD_DATA_BY_DATE = 'LOAD_DATA_BY_DATE';
var LOAD_DATE_LIST = exports.LOAD_DATE_LIST = 'LOAD_DATE_LIST';
var ADD_DATA_IN_DATE = exports.ADD_DATA_IN_DATE = 'ADD_DATA_IN_DATE';

function changeChosenDate(id, isLoaded) {
  ...
  if (isLoaded) {
    ...
    return function (dispatch) {
      new Promise(function (resolve, reject) {
        fetch('get_statistic?ID=' + id).then(function (res) {
          if (!res.ok) {
            res.text().then(function (textErr) {
              reject(textErr);
            });
          } else {
            resolve(res.json());
...
function addDataInDate(id, data) {
  return {
...
function loadDateList() {
  return function (dispatch) {
    fetch('/get_dateList').then(function (res) {
      return res.json();
    }).then(function (data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_symbol_observable__ = __webpack_require__(36);
...
var _MainContent = __webpack_require__(63);

var _MainContent2 = _interopRequireDefault(_MainContent);

var _LeftMenu = __webpack_require__(65);
...
var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default), window.STATE_FROM_SERVER);
...
*/
var ba=__webpack_require__(2),ea=__webpack_require__(1),m=__webpack_require__(13),A=__webpack_require__(4),C=__webpack_require__(3),fa=__webpack_require__(14),ha=__webpack_require__(15),ja=__webpack_require__(16),ka=__webpack_require__(5);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(17), __webpack_require__(37)(module)))
...
function dateView() {
    ...
    switch (action.type) {
        case _actions.CHANGE_CHOSEN_DATE:
            return Object.assign({}, state, {
                currentDateID: action.ID
            });
            break;

        case _actions.LOAD_DATA_BY_DATE + '_SUCCESS':
            return Object.assign({}, state, {
                currentDateID: action.ID,
                dateList: state.dateList.map(function (el) {
                    if (el.ID === action.ID) {
                        el.isLoaded = true;
                    }
                    return el;
                }),
                dateStatistic: Object.assign({}, state.dateStatistic, _defineProperty({}, action.ID, action.data))
            });
            break;

        case _actions.ADD_DATA_IN_DATE:
            return Object.assign({}, state, {
                dateStatistic: Object.assign({}, state.dateStatistic, _defineProperty({}, action.ID, [].concat(_toConsumableArray(state.dateStatistic[action.ID]), [action.data])))
            });
            break;

        case _actions.LOAD_DATE_LIST + '_SUCCESS':
...
var dateViewApp = (0, _redux.combineReducers)({
    dateView: dateView
});

exports.default = dateViewApp;
...
var _DataTable = __webpack_require__(64);
    ...
    _createClass(MainContent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { id: 'main_content' },
                _react2.default.createElement(_DataTable2.default, { data: data }),
                this.props.dateStatistic && this.props.currentDateID && this.props.dateStatistic[this.props.currentDateID].map(function (el) {
                    return _react2.default.createElement(_DataTable2.default, { data: el, key: el.ID });
                })
            );
        }
    }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        changeChosenDate: function changeChosenDate(id, isLoaded) {
            return dispatch((0, _actions.changeChosenDate)(id, isLoaded));
        },
        addDataInDate: function addDataInDate(id, data) {
            return dispatch((0, _actions.addDataInDate)(id, data));
        }
    };
};

exports.default = MainContent = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(MainContent);
...
var _DateList = __webpack_require__(66);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        loadDateList: function loadDateList() {
            return dispatch((0, _actions.loadDateList)());
        }
    };
};
    ...
    _createClass(LeftMenu, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { id: "left_date_list_search" },
                    _react2.default.createElement("div", { className: "date_picker" }),
                    _react2.default.createElement(
                        "div",
                        null,
                        "\u0412\u0438\u0431\u0435\u0440\u0456\u0442\u044C \u0434\u0430\u0442\u0443"
                    ),
                    _react2.default.createElement("div", { className: "arrow_down" }),
                    _react2.default.createElement("div", { className: "arrow_top" })
                ),
                this.props.dateList.map(function (el) {
                    return _react2.default.createElement(_DateList2.default, { date: el.Date, key: el.ID, ID: el.ID, isLoaded: el.isLoaded });
                })
            );
        }
    }]);
...
exports.default = LeftMenu = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(LeftMenu);
...
function DateList(props) {
    ...
    var classN = 'date_list_element' + (props.ID === props.currentDateID ? ' active' : '');
    return _react2.default.createElement(
        "div",
        { className: classN,
            onClick: function onClick() {
                return props.changeChosenDate(props.ID, props.isLoaded);
            } },
        _react2.default.createElement(
            "div",
            { className: "date_list_element_container" },
            _react2.default.createElement(
                "div",
                { className: "date_list_element_content" },
                _react2.default.createElement(
                    "h1",
                    null,
                    props.date
...
exports.default = DateList = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(DateList);
